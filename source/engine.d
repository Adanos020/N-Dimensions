...
public:
    ...
    void update(in Duration delta)
    {
        ...
        */
        //_hypercuboid.rotateXY(delta.total!"usecs" * 0.0000005);
        //_hypercuboid.rotateXZ(delta.total!"usecs" * 0.0000005);
        //_hypercuboid.rotateYZ(delta.total!"usecs" * 0.0000005);
        //_hypercuboid.rotateXW(delta.total!"usecs" * 0.0000005);
        //_hypercuboid.rotateYW(delta.total!"usecs" * 0.0000005);
        _hypercuboid.rotateZW(delta.total!"usecs" * 0.0000005);
